...
export default function InfoCard({ icon, title, value, color = '#1976d2', background = '#fff' }) {
  return (
    <div
    ...
    >
      <span className="dashboard-info-card-icon" style={{ fontSize: 36, color, flexShrink: 0 }}>
        {icon}
      </span>
