...
export default function BikeDetail() {
  ...
  if (!bike)
    return (
      <div className="page-pad">
        Kolo nenalezeno. <Link to="/my-bikes">Zpět</Link>
      </div>
    );
  ...
  return (
    <div className="page-pad">
      ...
      <p>
        <b>Odjeté minuty:</b> {bike.minutesRidden}
      </p>
      <p>
        <b>Typ:</b> {bike.type || '—'}
      </p>
      <p>
        <b>Brzdy:</b> {bike.brakes || '—'}
      </p>
      <p>
        <b>Odpružení:</b> {bike.suspension || '—'}
      </p>
      <p>
        <b>Specifikace:</b> {bike.specs || '—'}
      </p>
